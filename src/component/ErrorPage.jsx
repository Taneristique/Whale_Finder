...
export default class ErrorPage extends React.Component{
    render(){
        ...
        return(
            <div className='w-screen h-screen text-center  text-red-50  grid place-content-center ...'>
            <p className='whitespace-pre-line truncate	 text-red-50'>Operation could not realize,please check your console for more details.<br/>
